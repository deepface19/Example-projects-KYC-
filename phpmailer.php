...
class PHPMailer {
 ...
 /**
  ...
  // CONSTANTS
  /////////////////////////////////////////////////
    protected $sign_key_file = ''; // message only, continue processing
    protected $sign_key_pass = ''; // message?, likely ok to continue processing
    protected $exceptions = false; // message, plus full stop, critical error reached
